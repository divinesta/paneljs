      ...
      <main id="main">
        <section className="hero" aria-label="Introduction">
          ...
          <div className="hero-copy">
            ...
            <p className="hero-sub">
              Register models, keep your auth, and give operators a guarded UI
              and API from the schema your app already trusts.
            </p>
        ...
        <section className="stack-section" aria-label="Works with your stack">
          <div className="container">
            ...
            <p className="lede">
              PanelJS does not replace your app. You keep Express, Prisma, and
              your auth. The packages read the schema and serve the panel.
            </p>
        ...
        <section className="features" id="features">
          <div className="container feature-layout">
            <div className="feature-intro reveal">
              ...
              <p>
                You register models. At mount, PanelJS introspects{" "}
                <code>schema.prisma</code> and serves a React admin at{" "}
            ...
            <ul className="feature-list">
              ...
              <li className="reveal">
                ...
                <p>
                  There is no bundled login screen. If{" "}
                  <code>getCurrentUser</code> returns null, the API is 401. Wire
                  it to the session you already have.
                </p>
              </li>
              <li className="reveal">
          ...
          <div className="container">
            ...
            <ol className="calls">
              <li className="reveal">
                ...
                <p>
                  Pass a Prisma adapter and a <code>getCurrentUser</code>{" "}
                  function. The library never ships a development backdoor.
                </p>
              </li>
              <li className="reveal">
                <span>register</span>
              ...
              <li className="reveal">
                <span>mount</span>
                <p>
                  Attach the UI and API to your Express app. Deploy wherever
                  that app already runs.
                </p>
              </li>
            </ol>
          </div>
        ...
        <section className="code-section" id="install">
          <div className="container code-layout">
            <div className="code-copy reveal">
              ...
              <p>
                Point it at the Prisma client you already generate. Include{" "}
                <code>schema.prisma</code> in the deploy artifact, or pass{" "}
            ...
            <div className="code-panel reveal">
              ...
              <pre className="code-block">
                <code>
                  ...
                  <span className="tok-k">from</span>{" "}
                  <span className="tok-s">"@paneljs/paneljs"</span>
                  {"\n"}
        ...
        <section className="close">
          <div className="container close-inner reveal">
            ...
            <p>
              Install it, connect the auth you already have, and let the schema
              do the rest.
            </p>
            <div className="hero-ctas">
              <a href={docsStart} className="btn btn-primary btn-lg">
